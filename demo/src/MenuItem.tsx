  ...
  <div>
    <Section title="MenuItem">
      <SubSection title="normal">
        <MenuItem data={{ hover: false }} onChange={_ => { }}>MenuItem</MenuItem>
      </SubSection>
      <SubSection title="hover">
        <MenuItem data={{ hover: true }} onChange={_ => { }}>MenuItem:hover</MenuItem>
      </SubSection>
    ...
    <Section title="MenuItem in Menu">
      ...
      <SubSection title="two items (icons) with state + click handler">
        <Menu>
          <MenuItemWithState onClick={() => { alert('Click: Add') }}>
            <Icon name="add" style={{ marginRight: '0.5em' }} /> Add
          </MenuItemWithState>
          <MenuItemWithState onClick={() => { alert('Click: Edit') }}>
            <Icon name="edit" style={{ marginRight: '0.5em' }} /> Edit
          </MenuItemWithState>
        </Menu>
      </SubSection>
